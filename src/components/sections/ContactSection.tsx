...
export default function ContactSection() {
  return (
    <section className="h-full min-h-screen bg-[#FBF8F2] py-24 flex items-center" id="contacto">
      <div className="w-full px-6 lg:px-12 flex flex-col items-center text-center gap-8">
            ...
            return (
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[#333333] text-sm font-medium mt-0.5">{item.value}</p>
                </div>
              </a>
            );
          })}
        ...
        {/* WhatsApp */}
        <a
          href="https://wa.me/50231710897?text=Hola%20SysAdmin%20GT,%20me%20interesa%20una%20cotizacion"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
        >
        ...
        <div className="flex items-center gap-3">
          {socials.map((s) => (
            <a
              ...
              rel="noopener noreferrer"
              aria-label={s.label}
              className="w-10 h-10 rounded-lg border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#116776] hover:border-[#116776] transition-colors"
            >
